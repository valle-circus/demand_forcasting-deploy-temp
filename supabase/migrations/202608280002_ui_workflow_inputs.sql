-- Minimal source and risk persistence needed to exercise the three-page UI.
...
comment on table public.planning_netting_results is
    'Persisted NettingResult summaries used by location risk and overview; daily events remain deferred.';
