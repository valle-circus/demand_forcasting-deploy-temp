...
- [ ] Start Milestone 0 fixture/contracts work after human input on data handling.
...
- 2026-08-22: Start with versioned CSV/YAML. Introduce Supabase when durable multi-user config, inputs, runs, and approvals are needed.
...
## Next steps
- Get approval to extract and commit a minimal/anonymized KW34 fixture.
- Resolve P0 human questions H-01 through H-06 in the master backlog or record approved placeholders.
- Scaffold the Python package, validation schemas, and test harness.
