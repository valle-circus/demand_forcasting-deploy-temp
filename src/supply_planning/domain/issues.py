...
class ExceptionCode(StrEnum):
    ...
    SHELF_LIFE_COVERAGE_INCOMPLETE = "SHELF_LIFE_COVERAGE_INCOMPLETE"
    MAX_COVER_CAP_BINDING = "MAX_COVER_CAP_BINDING"
    MAX_COVER_COVERAGE_INCOMPLETE = "MAX_COVER_COVERAGE_INCOMPLETE"
    RECOMMENDATION_HORIZON_COVERAGE_INCOMPLETE = (
        "RECOMMENDATION_HORIZON_COVERAGE_INCOMPLETE"
    )
